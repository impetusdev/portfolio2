...
export default function Projects(props){
    return <div className='section' id='projects'>
        <div className='container'>
            ...
            <Project title='Metaverse Fighting Championship' imgSrc='projects/mfc.png' demo='https://metaverse-fc.netlify.app/' repo='https://github.com/thelorddoyle/mfc-front-end' description='A full stack NFT fighting group project, that allows users to mint unique fighters that participate in tournaments to win prizes. '></Project>
